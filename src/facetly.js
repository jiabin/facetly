...
var Facetly = Facetly || (function($) {
    ...
    Events = {
            ...
            serializeTerms: function(e) {
                ...
                for (q in query[name]) {
                    if (query[name][q].operator != '' && query[name][q].value != '') {
                        ...
                        if (Query.holder[name]['bool'] == undefined) {
                            Query.holder[name]['bool'] = {};
                        }

                        if (Query.holder[name]['bool'][query[name][q].operator] == undefined) {
                            Query.holder[name]['bool'][query[name][q].operator] = [];
                        }

                        var object = {};
                        object['wildcard'] = {};
                        object['wildcard'][name] = query[name][q].value;
                        Query.holder[name]['bool'][query[name][q].operator].push(object);
                        i++;
                    }
                }
                App.loadResults();
        ...
        serialize: function() {
            ...
            for (i in Query.holder) {
                query = Utils.deepExtend(query, Query.holder[i]);
            }
            var object = {query: jQuery.isEmptyObject(query) ? Query.matchAllQuery() : query, size: Utils.settings.perPage};
            var string = Query.create(jQuery.isEmptyObject(query) ? Query.matchAllQuery() : query);
    ...
    Templates = {
        ...
        types: {
            nested: '<ul id="facet-{{name}}"> \
                <li class="custom"> \
                    <select class="input-medium" name="{{name}}[0][operator]" data-type="operator" data-name="{{name}}" data-event="serializeNested" data-method="change"> \
                        <option value=""></option> \
                ...
                {{#each facet.terms}} \
                    <li> \
                        <select class="input-medium" name="{{../name}}[{{inc @index}}][operator]" data-name="{{../name}}" data-event="serializeNested" data-method="change"> \
                            <option value=""></option> \
                            <option value="must">Must</option> \
                            <option value="should">Should</option> \
                            <option value="must_not">Must Not</option> \
            ...
            terms: '<ul id="facet-{{name}}"> \
                <li class="custom"> \
                    <select class="input-medium" name="{{name}}[0][operator]" data-type="operator" data-name="{{name}}" data-event="serializeTerms" data-method="change"> \
                        <option value=""></option> \
                        <option value="must">Must</option> \
                        <option value="should">Should</option> \
                        <option value="must_not">Must Not</option> \
                ...
                {{#each facet.terms}} \
                    <li> \
                        <select class="input-medium" name="{{../name}}[{{inc @index}}][operator]" data-name="{{../name}}" data-event="serializeTerms" data-method="change"> \
                            <option value=""></option> \
                            <option value="must">Must</option> \
                            <option value="should">Should</option> \
                            <option value="must_not">Must Not</option> \
    ...
    UI = {
        init: function() {
            ...
            element.append(UI.sidebar);
            element.append(UI.results);
        },
 ...
 */
var deepExtend=function(){if(arguments.length<1||typeof arguments[0]!=="object"){return false}if(arguments.length<2)return arguments[0];var e=arguments[0];var t=Array.prototype.slice.call(arguments,1);var n,r,i,s;t.forEach(function(t){if(typeof t!=="object")return;for(n in t){if(t[n]!==void 0){i=e[n];r=t[n];if(r===e)continue;if(typeof r!=="object"||r===null){e[n]=r;continue}if(typeof i!=="object"){s=Array.isArray(r)?[]:{};e[n]=deepExtend(s,r);continue}if(Array.isArray(r)){s=Array.isArray(i)?i:[]}else{s=!Array.isArray(i)?i:{}}e[n]=deepExtend(s,r)}}});return e}